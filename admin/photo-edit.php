...
$sql = "SELECT * FROM tb_portofolio WHERE id = " . $_GET['id'];
                                        ...
                                        <div class="col-12">
                                            <form action="photo-edit-process.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <label>Judul</label>
                                                    <input type="text" name="judul" class="form-control" value="<?= $data[0]['judul'] ?>" required />
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img class="w-100" src="../uploads/<?= $data[0]['photo'] ?>" />
                                </div>
                                <div>
                                    <hr class="mt-0 mb-0">
                                </div>
